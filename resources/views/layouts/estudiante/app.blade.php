                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                         <li class="sidebar-item">
                            <livewire:frontend.components.notificaciones.estudiante />
                        </li>
                        <li class="sidebar-title">Menu</li>

                        <li
                            class="sidebar-item">
                            <a href="{{ route('estudiante.dashboard') }}"   class='sidebar-link'>
                        ...
                        <li
                            ...
                            <ul class="submenu ">                                
                                <li class="submenu-item  ">
                                    <a href="{{ route('estudiante.crear-fut') }}" wire:navigate  class="submenu-link">Crear</a>

                                </li>
                                <li class="submenu-item  ">
                                    <a href="{{ route('estudiante.futs-pendientes') }}" wire:navigate class="submenu-link">Pendientes</a>
                                </li>
                                <li class="submenu-item  ">
                                    <a href="{{ route('estudiante.futs-revisados') }}" wire:navigate class="submenu-link">Revisados</a>
                        ...
                        <li
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item  ">
                                    <a href="{{route('estudiante.carpetas-gestionadas')}}" wire:navigate class="submenu-link">Revisadas</a>
                                </li>
                                <li class="submenu-item  ">
                                    <a href="{{ route('estudiante.carpetas-pendientes') }}" wire:navigate class="submenu-link">En proceso</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
