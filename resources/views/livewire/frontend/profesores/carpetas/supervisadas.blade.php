<div class="card shadow-sm border-0 p-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold text-dark mb-0">Carpetas Supervisadas</h2>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <span class="badge bg-light-success text-success-emphasis border border-success-subtle px-3 py-2">
                               <i class="bi bi-check-circle-fill me-2"></i>{{$carpeta->estado}}
                            </span>
                        </td>
