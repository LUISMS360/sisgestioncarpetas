<div class="card shadow-sm border-0 p-4">
    <div class="d-flex align-items-center mb-4">
        ...
        <h2 class="fw-bold text-dark mb-0">Memorandos Emitidos</h2>
    </div>
    <div class="row g-3 mb-5">
        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <x-partials.complements.cardinfo title="Memorandos Emitidos I Modulo" content="{{ $memos_primer_ciclo }}">
                <i class="bi bi-1-circle-fill fs-4"></i>
            </x-partials.complements.cardinfo>
        </div>
        <div class="col-12 col-sm-6 col-xl-3">
            <x-partials.complements.cardinfo title="Memorandos Emitidos II Modulo" content="{{ $memos_segundo_ciclo }}">
                <i class="bi bi-2-circle-fill fs-4"></i>
            </x-partials.complements.cardinfo>
        </div>
        <div class="col-12 col-sm-6 col-xl-3">
            <x-partials.complements.cardinfo title="Memorandos Emitidos III Modulo" content="{{ $memos_tercer_ciclo }}">
    ...
    <div class=" p-4 rounded-4 mb-5 border">
        <div class="row align-items-center">
            <div class="col-md-8">
                ...
                <p class="text-muted small mb-3">Ingrese el Nombre</p>
    ...
    <div class="mb-5">
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    @forelse($this->emitidos() as $memorandon)
                    <tr>
                        <td class="px-3 fw-bold text-muted">{{$memorandon->id}}</td>
                        <td class="fw-semibold">{{$memorandon->profesor}}</td>
                        <td class="fw-bold text-dark">{{$memorandon->correo}}</td>
                        <td>
                            <button
                        ...
                        <td>
                            <div class="btn-group shadow-sm">
                                <a target="_blank" href="{{ route('admin.generar.pdf',['id'=>$memorandon->id]) }}" class="btn btn-sm btn-outline-danger"><i class="bi bi-file-earmark-pdf-fill"></i></a>                                
                                <a href="{{ route('admin.descargar.pdf',['id'=>$memorandon->id]) }}" class="btn btn-sm btn-outline-success"><i class="bi bi-file-arrow-down-fill"></i></a>
                            </div>
                        </td>
                    </tr>
                    @empty
